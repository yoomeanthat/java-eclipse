...
public class 파일복사버퍼2 {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedInputStream bis = new BufferedInputStream(new FileInputStream("res/img.jpg"));
             BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream("res/imgcopy4.jpg"))) {
